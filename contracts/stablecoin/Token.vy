...
NAME: constant(String[20]) = "one-buck"
SYMBOL: constant(String[5]) = "BUCK"
...
def mint(receiver: address, amount: uint256) -> bool:
    ...
    """
    assert msg.sender == self.minter, "Access is denied."
...
@external
def setMinter(minter_addr: address):
    """
    @notice Update the address allowed to mint tokens
